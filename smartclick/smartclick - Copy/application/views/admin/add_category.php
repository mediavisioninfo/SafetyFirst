        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php
				...
				?>	
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('admin/add_category'); ?>">
              <div class="box-body">
			    ...
			    <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputfnm" placeholder="Enter Category Name" name="category">
                </div>
