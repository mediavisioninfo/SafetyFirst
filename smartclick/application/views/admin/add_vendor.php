        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php
				...
				?>	
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('admin/add_vendor'); ?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputfnm" placeholder="Enter Email" name="email">
                </div>
