  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Restaurant Review Tables
        <small>Restaurant Review tables</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Restaurant Review </a></li>
        <li class="active">Restaurant Review tables</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?></span></td>
                  <td><a href="<?php echo base_url('admin/reviewview/'.$listing['res_id']); ?>" class="btn btn-success">View</a></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
                <tfoot>
