...
if (!function_exists('settingsKeys')) {
    function settingsKeys()
    {
        return $settingsKeys = [
            ...
            "agent_number_prefix" => "#AGT-000",
            "insurance_number_prefix" => "#INS-000",
            "claim_number_prefix" => "#CLM-000",
            'CURRENCY' => "USD",
            'CURRENCY_SYMBOL' => "$",
            'STRIPE_PAYMENT' => "off",
            'STRIPE_KEY' => "",
...
if (!function_exists('agentPrefix')) {
    function agentPrefix()
    {
        $settings = settings();
        return $settings["agent_number_prefix"];
    }
}
if (!function_exists('insurancePrefix')) {
    function insurancePrefix()
    {
        $settings = settings();
        return $settings["insurance_number_prefix"];
    }
}
if (!function_exists('claimPrefix')) {
    function claimPrefix()
    {
        $settings = settings();
        return $settings["claim_number_prefix"];
    }
}
...
if (!function_exists('userLoggedHistory')) {
    ...
    if(!function_exists('defaultAgentCreate')){
        function defaultAgentCreate($id)
        {
            // Default Customer role
            $agentRoleData= [
                'name' => 'agent',
            ...
            $systemAgentRole = Role::create($agentRoleData);
            // Default Agent permissions
            $systemAgentPermissions = [
                ['name' => 'manage contact'],
                ['name' => 'create contact'],
                ['name' => 'edit contact'],
                ['name' => 'delete contact'],
            ...
            $systemAgentRole->givePermissionTo($systemAgentPermissions);
            return $systemAgentRole;
        }
    }
    ...
    if (!function_exists('convertNumberToWords')) {
         ...
         *
         * Supports numbers up to crores (Indian numbering system).
         *
        ...
        function convertNumberToWords($number) {
            ...
            // Array to store word representation of numbers
            $words = array(
