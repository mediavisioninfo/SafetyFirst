...
@php
    use App\Models\User; 
    $users = User::where('type','Operator')->orderBy('name')->get();
@endphp
     ...
     <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="d-flex gap-3">
            <form method="GET" action="{{ route('claim.index') }}" id="vehicleFilterForm">
                <select name="vehicle_type" onchange="document.getElementById('vehicleFilterForm').submit()" class="form-select">
                    ...
                    <option value="more" {{ request('vehicle_type') == 'more' ? 'selected' : '' }}>More than 4-Wheeler</option>
                </select>
            </form>
                    ...
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <tbody>
                            @foreach ($claims as $claim)
                                <tr>
                                    <td><input type="checkbox" name="claim_ids[]" value="{{ $claim->id }}" class="claim-checkbox"></td>
                                    ...
                                    <td>{{ !empty($feesBillData[$claim->id]['total_amount']) ? $feesBillData[$claim->id]['total_amount'] : '0.00' }}</td>  
                                            ...
                                            <div class="cart-action">
                                                ...
                                                @if (Gate::check('edit claim'))
                                                    <a class="text-success customModal" data-bs-toggle="tooltip"
                                                        ...
                                                        href="#" data-url="{{ route('claim.edit', $claim->id) }}"
                                                        data-title="{{ __('Edit Claim') }}"> <i
                                                ...
                                                <a class="text-primary" data-bs-toggle="tooltip"
                                                    data-bs-original-title="{{ __('Copy Upload Link') }}"
                                                ...
                                                @if (Gate::check('manage claim'))
                                                    <a class="text-info customModal" data-bs-toggle="tooltip"  data-size="lg"
                                                        ...
                                                        href="#" data-url="{{ route('claim.log', $claim->id) }}" data-title="{{ __('View Logs') }}">
