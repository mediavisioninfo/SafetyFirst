...
<div class="modal-body">
    <div class="row">
      ...
      <div class="form-group">
            {{Form::label('agent_limit',__('Agent Limit'),array('class'=>'form-label'))}}
            {{Form::number('agent_limit',null,array('class'=>'form-control','placeholder'=>__('Enter agent limit'),'required'=>'required'))}}
        </div>
