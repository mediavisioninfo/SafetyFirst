...
<section class="intro" id="demos">
                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s">Safety First - AI Based Claim Assessment System</h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">The system automates the process of evaluating insurance claims, utilizing advanced AI algorithms and machine learning. By analyzing photos, videos, and related documents provided by the insured parties, the system can assess damage, estimate repair costs, and even detect potential fraud. It reduces human error, speeds up the claims process, and ensures consistent decision-making. This technology enhances efficiency, allowing insurers to process claims faster, improve customer satisfaction, and optimize operational costs.</p>
    ...
    <div class="landing_dash">
        <img class="" src="{{ asset('assets/images/landing/Picture2.png') }}" alt="">
    </div>
</section>
<!-- intro end-->
<!-- demo start-->
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            <div class="product-imgwrap">
                                <img class="img-fluid" src="{{ asset('assets/images/landing/1.png') }}" alt="1.jpg">
                            </div>
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Dashboard')}}</h5>
                                    <p>{{__('The software is built to cater to the needs of insurance companies, brokers, and agents, providing a centralized platform to manage all aspects of the insurance lifecycle.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->customer_limit}}</span>{{__('Customer Limit')}}</li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->agent_limit}}</span>{{__('Agent Limit')}}</li>
